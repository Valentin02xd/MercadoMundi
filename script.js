document.addEventListener('DOMContentLoaded', () => {
    // Función para formatear precios con separador de miles (punto)
    ...
    const products = [
        ...
        { id: 1, name: 'Camara web 1080p', category: 'Periféricos', brand: 'Loogitech', price: 85000, stock: 15, image: 'imagenes/descarga (1).jpg', bestSeller: true, onSale: false },
        // ID 2: Mouse
        { id: 2, name: 'Mouse gamer Razer cobra RGB', category: 'Periféricos', brand: 'Razer', price: 65000, originalPrice: 85000, stock: 25, image: 'imagenes/D_Q_NP_879184-MLU73709958761_122023-O.jpg', bestSeller: false, onSale: true },
        // ID 3: Monitor
        { id: 3, name: 'Monitor Samsung 27" Curvo F390', category: 'Periféricos', brand: 'Samsung', price: 320000, originalPrice: 380000, stock: 10, image: 'imagenes/Monitor-Samsung-27-Curvo-F390-60hz-1920-X-1080.jpg', bestSeller: true, onSale: true },
        // ID 4: Auriculares
        { id: 4, name: 'Auriculares Inalámbricos Bluetooth Sony WH-CH520 Negro', category: 'Periféricos', brand: 'Sony', price: 180000, stock: 8, image: 'imagenes/descarga.jpg', bestSeller: false, onSale: false },
        // ID 5: Micrófono
        { id: 5, name: 'Micrófono Gadnic MIC-40PRO Condensador USB', category: 'Periféricos', brand: 'Gadnic', price: 125000, stock: 12, image: 'imagenes/descarga (2).jpg', bestSeller: false, onSale: false },
        // ID 6: Disco Duro
        { id: 6, name: 'Disco Duro Externo 2TB WD Elements USB 3.0', category: 'Componentes de PC', brand: 'Elements', price: 140000, originalPrice: 165000, stock: 30, image: 'imagenes/descarga (3).jpg', bestSeller: true, onSale: true },
        // ID 7: Procesador
        { id: 7, name: 'Procesador AMD Ryzen 5 5600X', category: 'Componentes de PC', brand: 'AMD', price: 245000, stock: 20, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.24.58.jpg', bestSeller: false, onSale: false },
        // ID 8: Placa de Video
        { id: 8, name: 'Placa de video RTX 30 serie 3070', category: 'Componentes de PC', brand: 'NVIDIA', price: 850000, stock: 18, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.05.jpg', bestSeller: false, onSale: false },
        // ID 9: Memoria RAM
        { id: 9, name: 'Kit de memoria de 32 GB DDR4', category: 'Componentes de PC', brand: 'Corsair', price: 195000, stock: 7, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.19.jpg', bestSeller: false, onSale: false },
        // ID 10: Placa Madre Asus Prime X870-p Wifi
        { id: 10, name: 'Motherboard Asus Prime X870-p Wifi Amd Am5 Atx Ddr5 Pcie 5.0', category: 'Componentes de PC', brand: 'AMD', price: 480000, originalPrice: 560000, stock: 10, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.22.jpg', bestSeller: false, onSale: true },
        // ID 11: Placa Madre Gigabyte Amd A520m V2 D
        { id: 11, name: 'Motherboard Gigabyte Amd A520m V2 Ddr4 Gamer Colo Negro', category: 'Componentes de PC', brand: 'Gigabyte', price: 95000, stock: 22, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.24.jpg', bestSeller: true, onSale: false },
        // ID 12: Disco Sólido
        { id: 12, name: 'Disco Sólido SSD Kingston A400 960GB', category: 'Componentes de PC', brand: 'Kingston', price: 110000, stock: 14, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.28.jpg', bestSeller: false, onSale: false },
        // ID 13: Gabinete Gamer Thermaltake X4 Fans View 380 Tg Ar
        { id: 13, name: 'Gabinete Gamer Thermaltake X4 Fans View 380 Tg Argb Blanco', category: 'Componentes de PC', brand: 'Thermaltake', price: 175000, stock: 28, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.30.jpg', bestSeller: false, onSale: false },
        // ID 14: Gabinete Gamer Cougar Duoface RGB e-ATX
        { id: 14, name: 'Gabinete Gamer Cougar Duoface RGB e-ATX', category: 'Componentes de PC', brand: 'Cougar', price: 145000, stock: 17, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.32.jpg', bestSeller: false, onSale: false },
        // ID 15: Monitor
        { id: 15, name: 'Monitor Valkyrie Vh2410v2 200hz-144hz G-sync 24 1ms Ips Hdr', category: 'Periféricos', brand: 'Valkyrie', price: 280000, stock: 20, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.35.jpg', bestSeller: false, onSale: false },
        // Nuevos productos adicionales
        // ID 16: Teclado
        { id: 16, name: 'Teclado Redragon Ucal Pro Wireless 75%', category: 'Periféricos', brand: 'Redragon', price: 98000, originalPrice: 125000, stock: 12, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.36.jpg', bestSeller: true, onSale: true },
        // ID 17: Placa de Video RTX 3070 Ti
        { id: 17, name: 'Placa De Video RTX 3070 Ti 8 GB Gddr6x', category: 'Componentes de PC', brand: 'NVIDIA', price: 1050000, stock: 8, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.24.57.jpg', bestSeller: false, onSale: false },
        // ID 18: Procesador Gamer Ryzen 7 5700X
        { id: 18, name: 'Procesador Gamer Ryzen 7 5700X y 3.4ghz S/video', category: 'Componentes de PC', brand: 'AMD', price: 310000, stock: 35, image: 'imagenes/WhatsApp Image 2025-06-05 at 10.25.38.jpg', bestSeller: false, onSale: false }
    ];
    ...
    function createProductCardHtml(product) {
        let priceHtml = `<p class="price">ARS $${formatPrice(product.price)}</p>`;
        if (product.onSale && product.originalPrice) {
            priceHtml = `
                <p class="price">
                    <span class="original-price">ARS $${formatPrice(product.originalPrice)}</span>
    ...
    function addToCart(productId, quantity) {
        ...
        if (productInStore.stock === 0) {
            showToast(`Lo sentimos, ${productInStore.name} está actualmente agotado.`, 'error');
            return;
        }

        if (quantity > productInStore.stock) {
            showToast(`Solo quedan ${productInStore.stock} unidades de ${productInStore.name}.`, 'error');
            const productCardQuantityInput = document.getElementById(`quantity-input-${productId}`);
        ...
        showToast(`Añadido: ${quantity} x ${productInStore.name}`);
        saveCart();
        renderCart();
    ...
    function renderCart() {
        ...
        if (cartItems.length === 0) {
            ...
            cartTotalSpan.textContent = 'ARS $0,00';
        ...
        cartItems.forEach(item => {
            ...
            itemElement.innerHTML = `
                ...
                <div class="cart-item-details">
                    <h4>${item.name}</h4>
                    <p>ARS $${item.price ? formatPrice(item.price) : 'N/A'} x ${item.quantity} = ARS $${formatPrice(subtotal)}</p>
                </div>
        ...
        cartTotalSpan.textContent = `ARS $${formatPrice(total)}`;
        updateCartIconCount();
    }
    ...
    function updateCartItemQuantity(productId, newQuantity) {
        ...
        if (quantityDifference > 0) { // Aumentando cantidad
            if (quantityDifference > productInStore.stock) {
                showToast(`Solo puedes añadir ${productInStore.stock} unidades más de ${productInStore.name}.`, 'error');
                const inputField = cartItemsListDiv.querySelector(`.cart-quantity-input[data-product-id="${productId}"]`);
                if (inputField) inputField.value = originalCartQuantity; 
                return;
            }
    ...
    if (checkoutButton) {
        checkoutButton.addEventListener('click', () => {
            ...
            let totalAmount = 0;
            cartItems.forEach(item => {
                orderSummary += `${item.quantity} x ${item.name} - ARS $${formatPrice(item.price * item.quantity)}\n`;
                totalAmount += item.price * item.quantity;
            });
            orderSummary += `\nTotal: ARS $${formatPrice(totalAmount)}`;

            // La actualización de stock ya se hace en tiempo real al añadir/modificar/eliminar del carrito.
            showToast(`¡Compra finalizada! Total: ARS $${formatPrice(totalAmount)}`);
